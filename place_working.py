...
def main():
    ...
    try:
        ...
        if args.home:
            ...
            print("\n" + "="*60)
            print("Part 4.1: Slave Arm - Move to Place 2 Position")
            print("="*60)
            execute_smooth_move(
                slave_arm, PLACE_2_POSITION_POSE,
                MOVEMENT_TIME_SECONDS, JOINT_ACCELERATION, JOINT_VELOCITY, "Slave"
            )

            print("\n" + "="*60)
            print("Part 4.2: Slave Arm - Move to Take 2 Position")
            print("="*60)
            execute_smooth_move(
                slave_arm, SLAVE_TAKE2_POSITION_POSE,
                MOVEMENT_TIME_SECONDS, JOINT_ACCELERATION, JOINT_VELOCITY, "Slave"
            )

            print("\nClosing slave gripper...")
            slave_gripper.rg_close()
            print("✓ Slave gripper close command sent.")
            ...
            print("\n" + "="*60)
            print("Part 4.3: Slave Arm - Move to Give 2 Position")
            print("="*60)
            execute_smooth_move(
                slave_arm, SLAVE_GIVE2_POSITION_POSE,
                MOVEMENT_TIME_SECONDS, JOINT_ACCELERATION, JOINT_VELOCITY, "Slave"
            )

            print("\n" + "="*60)
            print("Part 4.4: Master Arm - Move to Take Position")
            print("="*60)
            execute_smooth_move(
                master_arm, MASTER_TAKE_POSITION_POSE,
                MOVEMENT_TIME_SECONDS, JOINT_ACCELERATION, JOINT_VELOCITY, "Master"
            )

            print("\n" + "="*60)
            print("Part 4.5: Second Handoff - Slave to Master")
            print("="*60)

            print("!!! MASTER GRIPPER CLOSING TO TAKE OBJECT !!!")
            master_gripper.rg_close()
            print("✓ Master gripper close command sent.")
            ...
            print("\n!!! SLAVE GRIPPER OPENING TO RELEASE OBJECT !!!")
            slave_gripper.rg_open()
            print("✓ Slave gripper open command sent.")

            print("\n✓ Second handoff complete.")

            print("\n" + "="*60)
            print("Part 4.6: Master Arm - Place Operation")
            print("="*60)
            execute_smooth_move(
                master_arm, MASTER_PLACE_POSITION_POSE,
                MOVEMENT_TIME_SECONDS, JOINT_ACCELERATION, JOINT_VELOCITY, "Master"
            )

            print("\nOpening master gripper...")
            master_gripper.rg_open()
            print("✓ Master gripper open command sent.")
