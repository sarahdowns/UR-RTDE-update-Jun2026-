...
# Singularity check
from singularity_check import correct_and_check_trajectory, plot_trajectories
...
# --- Add predefined approach waypoints ---
...
T_pose = ur_pose_to_transformation(tcp_pose_to_ball)
