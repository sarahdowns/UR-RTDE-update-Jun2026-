...
# Pose 4: Move linearly to the ball detected position (TCP pose)
tcp_pose_to_ball = [x, y, z, math.pi, 0, 0]
path.addEntry(PathEntry(PathEntry.MoveL, PathEntry.PositionTcpPose,[*tcp_pose_to_ball, vel, acc, 0.0]))

# Add two joint movements to the path
#pos1 = [0.156, 0.1579, 0.4248, -1.295, -0.198, -0.895]
#joint1 = [-1.0, -1.5, -2.0, -1.643, 2.679, 0.014]

#path.addEntry(PathEntry(PathEntry.MoveJ, PathEntry.PositionTcpPose, pos1 + [vel, acc, 0.0]))
#path.addEntry(PathEntry(PathEntry.MoveJ, PathEntry.PositionJoints, joint1 + [vel, acc, 0.0]))
