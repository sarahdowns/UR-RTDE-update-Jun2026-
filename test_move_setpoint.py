...
def main():
    ...
    initial_home_q = robot.rtde_r.getActualQ()
    try:    	
        ...
        roll_deg = -90
        yaw_deg= 90
        #rg_gripper.rg_grip(20, 25.0)
        #robot.move_to_xyz_safe(x, y, z + 0.05, roll_deg = roll_deg, pitch_deg=pitch_deg, yaw_deg=yaw_deg, speed=0.15, acceleration=0.2)
   	...
   	# 3. Capture baseline force before the final descentn
        ...
        # 4. Check force
        if robot.move_to_xyz_safe(x, y, z, roll_deg = roll_deg, pitch_deg=pitch_deg, yaw_deg=yaw_deg):
